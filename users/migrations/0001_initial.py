    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.CharField(blank=True, max_length=255, null=True, verbose_name='Link Image')),
                ('notification_token', models.CharField(blank=True, max_length=255, null=True, verbose_name='Token Notificaciones')),
